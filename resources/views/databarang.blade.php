        ...
        <main>
            <div class="container-fluid">
                ...
                <button type="button" style="border-radius: 10px;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <i class="bi bi-folder-plus"></i> Tambah Data Barang
                </button>
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            <div class="modal-header bg-primary">
                                <h1 class="modal-title fs-6 text-white" id="exampleModalLabel">Form Tambah Data Barang</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>

                            <!-- Modal Body -->
                            <div class="modal-body">
                                <form id="dynamicForm" action="{{ route('master-barang.store') }}" method="POST">
                                    @csrf
                                    <div id="formInputs">
                                        <div class="form-group mb-3 d-flex">
                                            <input type="text" name="kode_barang[]" placeholder="Kode Barang" class="form-control me-2" required>
                                            <input type="text" name="jenis_barang[]" placeholder="Jenis Barang" class="form-control me-2" required>
                                            <input type="text" name="nama_barang[]" placeholder="Nama Barang" class="form-control me-2" required>
                                    ...
                                    <button type="button" class="btn btn-danger" id="removeButton"><i class="bi bi-trash3"></i> Hapus Item</button>
